...
const int MAX_HP = 6;
#define PLAYER_HEX 0xB2  // Kode HEX Player 1
#define OPPONENT_HEX 0xA1  // Kode HEX Player 2
...
// 🛠 ESP-NOW VARIABLES
uint8_t opponentAddress[] = {0x5C, 0x01, 0x3B, 0x67, 0x7B, 0xC4}; // Ganti dengan alamat MAC Player 2
